...
#
class GetaujourdhuiIntentHandler(AbstractRequestHandler):
    
    def can_handle(self, handler_input):
        return is_intent_name("GetaujourdhuiIntent")(handler_input)
    ...
    def handle(self, handler_input):
        ...
        #-------------------------------------
        #search_record['fields']['date'] == "2022-06-24"
        
            
        
        choix_use = search_record['fields']['choix'] 
        date_use = search_record['fields']['date']
        #-------------------------------------

        
        
        speech_output = random.choice(language_prompts['GET_aujourdhui_CONFIRMED']).format(date_use, search_record, choix_use, choix_use, choix_use)

        
        reprompt = random.choice(language_prompts['GET_aujourdhui_REPROMPT_CONFIRMED'])
...
sb.add_request_handler(GetaujourdhuiIntentHandler())
